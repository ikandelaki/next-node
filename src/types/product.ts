...
export const Product = z.object({
  ...
  sku: z
    .string()
    .trim()
    .max(20, { error: "Sku should not be more than 20 characters long" }),
  price: z.coerce
    .number("Price should be a valid number")
    .optional()
    .default(0),
  discountPrice: z.coerce
    .number("Discount price should be a valid number")
    .optional()
    .default(0),
  discountPercentage: z.coerce
    .number("Discount percentage should be a valid number")
    .optional()
    .default(0),
  quantity: z.coerce
    .number("Quantity should be a valid number")
    .optional()
    .default(0),
